            ...
            @if (! $this->enabled)
                <x-jet-confirms-password wire:then="enableTwoFactorAuthentication">
                    <x-jet-button type="button" wire:loading.attr="disabled">
                        <div wire:loading wire:target="enableTwoFactorAuthentication" class="spinner-border spinner-border-sm" role="status">
                ...
                @elseif ($showingConfirmation)
                    <x-jet-confirms-password wire:then="confirmTwoFactorAuthentication">
                        <x-jet-button type="button" class="mr-3" wire:loading.attr="disabled">
                            <div wire:loading wire:target="confirmTwoFactorAuthentication" class="spinner-border spinner-border-sm" role="status">
                                <span class="visually-hidden sr-only">Loading...</span>
                            </div>
                            {{ __('Confirm') }}
                        </x-jet-button>
